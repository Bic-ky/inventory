...
urlpatterns = [
    ...
    path(
        "delivery-details/<int:delivery_id>/",
    ...
    path(
        "get-filler-vehicle/<int:filler_id>/",
        views.get_filler_vehicle,
        name="get_filler_vehicle",
    ),
    path("fillers/", views.filler_list, name="filler_list"),
    path("fillers/<int:pk>/", views.filler_detail, name="filler_detail"),
    path(
        "filler_ledger_detail/<int:filler_id>/",
        views.filler_ledger_detail,
        name="filler_ledger_detail",
    ),
    path(
        "delivery/record/<int:delivery_id>/",
        views.record_delivery,
        name="record_delivery",
    ),
    path(
        "delivery/complete/<int:delivery_id>/",
